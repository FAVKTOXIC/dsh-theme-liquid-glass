...
/* Sidebar shell: frosted glass edge refraction + luminous edge, applied via
   ::before so the backdrop-filter never re-anchors the sidebar's own children.
   The shell keeps its own --dsw-specific-sidebar-fill background (set by
   buildTokens); the ::before provides only the refraction + edge highlight. */
